...
fun PrimaryBlackButton(
    ...
    CustomButton(
        ...
        expandTextBetweenTrailingIcon = false,
...
@Composable
fun TertiaryWhiteButtonWithTrailingIcon(
    modifier: Modifier = Modifier,
    buttonText:UiText.StringResourceText,
    isEnable:Boolean=true,
    isLoading:Boolean=false,
    ...
    ExpandedCustomButton(
        ...
        trailingIcon = {
            if(trailingIcon!=null)
                ...
                Image(painter = painterResource(Res.drawable.ic_arrow), contentDescription = ExtConstants.StringConstants.EMPTY)
        },
        isClickable = isButtonEnable,
        onClickAction = onClickAction,
        showLoader = isLoading,
...
@Preview(showBackground = true, backgroundColor = 0xFFFFFFFF, heightDp = 100, widthDp = 400)
@Composable
private fun TertiaryWhiteButtonWithTrailingIcon(){
    AppTheme {
